...
switch regionAb{regionInd}
    ...
    case 'europe'
        models = {'access1-0', 'access1-3', 'bnu-esm', 'canesm2', ...
                  ...
                  'hadgem2-es', 'ipsl-cm5a-mr', 'miroc-esm'};
    case 'med'
        models = {'access1-0', 'access1-3', 'bnu-esm', 'cnrm-cm5', 'csiro-mk3-6-0', ...
                  'gfdl-cm3', 'gfdl-esm2g', 'gfdl-esm2m', 'hadgem2-cc', ...
                  'hadgem2-es', 'ipsl-cm5a-mr', 'miroc-esm'};
    case 'sa-n'
...
%                   'mpi-esm-mr'};
%               
% elseif strcmp(regionAb{regionInd}, 'europe')
%     % leave out mri-cgcm3, gfdl-esm2m, gfdl-esm2g', csiro due to bad temp performance
%     models = {'access1-0', 'access1-3', 'bnu-esm', 'canesm2', ...
%                   'cmcc-cm', 'cmcc-cms', 'cnrm-cm5', ...
%                   'gfdl-cm3', 'hadgem2-cc', ...
%                   'hadgem2-es', 'ipsl-cm5a-mr', 'miroc-esm', ...
