...
for i = 1:length(regionNames)
    ...
    if strcmp(regionAb{i}, 'amazon') || strcmp(regionAb{i}, 'sa-n')
        ...
        modelSubset = {'access1-0', 'access1-3', 'bnu-esm', ...
                      ...
                      'mpi-esm-mr', 'mri-cgcm3'};
    elseif strcmp(regionAb{i}, 'india')
        ...
        modelSubset = {'access1-0', 'access1-3', 'bnu-esm', 'canesm2', ...
                      ...
                      'hadgem2-es', 'ipsl-cm5a-mr', 'miroc-esm', ...
                      'mpi-esm-mr'};
    elseif strcmp(regionAb{i}, 'africa')
        % leave out 'mri-cgcm3'
        modelSubset = {'access1-0', 'access1-3', 'bnu-esm', 'canesm2', ...
                      'cmcc-cm', 'cmcc-cms', 'cnrm-cm5', 'csiro-mk3-6-0', ...
                      'gfdl-cm3', 'gfdl-esm2g', 'gfdl-esm2m', 'hadgem2-cc', ...
                      'hadgem2-es', 'ipsl-cm5a-mr', 'miroc-esm', ...
                      'mpi-esm-mr'};
    elseif strcmp(regionAb{i}, 'us-cent') || strcmp(regionAb{i}, 'us-se') || ...
            strcmp(regionAb{i}, 'europe') || strcmp(regionAb{i}, 'med')
    ...
    for m = 1:length(availModels)
        ...
        if ismember(models{m}, modelSubset)
            modelInd(end+1) = m;
        end
    end
    ...
    if showPercentChange
        export_fig(['seasonal-analysis-' regionAb{i} '-' tempMetric '-percent.png;'], '-m2');
    else
        export_fig(['seasonal-analysis-' regionAb{i} '-' tempMetric '-absolute.png;'], '-m2');
    end
    close all;
end
