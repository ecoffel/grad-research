...
for g = 1:4
    ...
    for model = 1:length(models)
        ...
        if exist(['2019-electricity/gmt-anomaly-temps/us-eu-pp-' num2str(g) 'deg-runoff-cmip5-' models{model} '.csv'], 'file')
            continue;
        end
        ...
        csvwrite(['2019-electricity/gmt-anomaly-temps/us-eu-pp-' num2str(g) 'deg-runoff-cmip5-' models{model} '.csv'], modelPlantTxTimeSeries);   
