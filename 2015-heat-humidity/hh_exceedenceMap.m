...
for s = 1:34
    load([baseDir 'selGrid-' num2str(decade) 's-' rcp '-scenario-' num2str(s)]);
...
saveData = struct('data', {result}, ...
                  ...
                  'fileTitle', ['exceedenceMap-' num2str(thresh) 'C-' rcp '-' num2str(decade) '-10p.pdf'], ...
                  'plotXUnits', 'Occurrences', ...
                  'blockWater', false);
plotFromDataFile(saveData);


result = {lat, lon, nanmean(mapData, 3)};
saveData = struct('data', {result}, ...
                  'plotRegion', 'world', ...
                  'plotRange', [0 30], ...
                  'plotTitle', [num2str(thresh) 'C wet bulb events, 2070s, mean'], ...
                  'fileTitle', ['exceedenceMap-' num2str(thresh) 'C-' rcp '-' num2str(decade) '-mean.pdf'], ...
                  'plotXUnits', 'Occurrences', ...
                  'blockWater', false);
plotFromDataFile(saveData);
...
saveData = struct('data', {result}, ...
                  ...
                  'fileTitle', ['exceedenceMap-' num2str(thresh) 'C-' rcp '-' num2str(decade) '-90p.pdf'], ...
                  'plotXUnits', 'Occurrences', ...
                  'blockWater', false);
plotFromDataFile(saveData);
