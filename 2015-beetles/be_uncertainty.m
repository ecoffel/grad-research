...
if ciPlot
    ...
    saveData = struct('data', {resultLow}, ...
                      ...
                      'fileTitle', ['toe-ci-' num2str(tcrit) '-' num2str(100-ciThresh) 'p-' fileExt '.png'], ...
                      'plotXUnits', 'Year', ...
                      'blockWater', true, ...
                      'plotStates', true, ...
                      'plotCountries', false, ...
    ...
    saveData = struct('data', {resultHigh}, ...
                      ...
                      'fileTitle', ['toe-ci-' num2str(tcrit) '-' num2str(ciThresh) 'p-' fileExt '.png'], ...
                      'plotXUnits', 'Year', ...
                      'blockWater', true, ...
                      'plotStates', true, ...
                      'plotCountries', false, ...
    ...
    if plotAllModels
        for r = 1:size(rankings, 3)
            ...
            saveData = struct('data', {result}, ...
                              ...
                              'fileTitle', ['toe-model-range-' num2str(tcrit) '-' rankingsNames{r} '-' rcps{1} '-' kvals{1} '.png'], ...
                              'plotXUnits', 'Year', ...
                              'blockWater', true, ...
                              'plotStates', true, ...
                              'plotCountries', true, ...
        ...
        saveData = struct('data', {resultLow}, ...
                          ...
                          'fileTitle', ['toe-model-range-lower-' num2str(tcrit) '-' fileExt '.png'], ...
                          'plotXUnits', 'Year', ...
                          'blockWater', true, ...
                          'plotStates', true, ...
                          'plotCountries', true, ...
        ...
        saveData = struct('data', {resultHigh}, ...
                          ...
                          'fileTitle', ['toe-model-range-upper-' num2str(tcrit) '-' fileExt '.png'], ...
                          'plotXUnits', 'Year', ...
                          'blockWater', true, ...
                          'plotStates', true, ...
                          'plotCountries', true, ...
...
saveData = struct('data', {{lat, lon, nanmean(rankings, 3)}}, ...
                  ...
                  'fileTitle', ['toe-multi-run-mean-' num2str(tcrit) '-' fileExt '.png'], ...
                  'plotXUnits', 'Year', ...
                  'blockWater', true, ...
                  'plotStates', true, ...
                  'plotCountries', true, ...
