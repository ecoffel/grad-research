baseDir = 'C:\git-ecoffel\grad-research\2015-beetles\bt-output';
    ...
    for k = 1:length(kvals)
        ...
        for e = ensembles
            for thresh = thresholds
                for r = 1:length(rcps)
                    if strcmp(model, 'mm')
                        path = [baseDir '\bt-toe-bc-' curK '-r' num2str(e) 'i1p1-' model '-' rcps{r} '-bt-' num2str(thresh) '-perc-' num2str(tcrit) '-cmip5-all-ext-2006-2090-cmip5-1985-2004.mat'];
                    else
                        path = [baseDir '\bt-toe-bc-' curK '-r' num2str(e) 'i1p1-' model '-' rcps{r} '-bt-' num2str(thresh) '-perc-' num2str(tcrit) '-cmip5-all-ext-2006-2090-cmip5-1985-2004-' model '.mat'];
                    end
                    load(path);
...
if ciPlot
    ...
    saveData = struct('data', {resultLow}, ...
                      'plotRegion', 'usne', ...
                      'plotRange', [2005 2090], ...
                      'plotTitle', ['Time of emergence, ' num2str(100-ciThresh) '% threshold'], ...
                      'fileTitle', ['toe-ci-' num2str(tcrit) '-' num2str(100-ciThresh) 'p-' fileExt '.pdf'], ...
                      'plotXUnits', 'Year', ...
                      'blockWater', true, ...
                      'plotStates', true, ...
                      'plotCountries', false, ...
    ...
    saveData = struct('data', {resultHigh}, ...
                      'plotRegion', 'usne', ...
                      'plotRange', [2005 2090], ...
                      'plotTitle', ['Time of emergence, ' num2str(ciThresh) '% threshold'], ...
                      'fileTitle', ['toe-ci-' num2str(tcrit) '-' num2str(ciThresh) 'p-' fileExt '.pdf'], ...
                      'plotXUnits', 'Year', ...
                      'blockWater', true, ...
                      'plotStates', true, ...
                      'plotCountries', false, ...
...
if modelRangePlot
    if plotAllModels
        for r = 1:size(rankings, 3)
            result = {lat, lon, rankings(:, :, r)};
            
            saveData = struct('data', {result}, ...
                              'plotRegion', 'usne', ...
                              'plotRange', [2005 2090], ...
                              'plotTitle', 'Time of emergence', ...
                              'fileTitle', ['toe-model-range-' num2str(tcrit) '-' rankingsNames{r} '-' rcps{1} '-' kvals{1} '.pdf'], ...
                              'plotXUnits', 'Year', ...
                              'blockWater', true, ...
                              'plotStates', true, ...
                              'plotCountries', true, ...
        ...
        saveData = struct('data', {resultLow}, ...
                          ...
                          'fileTitle', ['toe-model-range-lower-' num2str(tcrit) '-' fileExt '.pdf'], ...
                          'plotXUnits', 'Year', ...
                          'blockWater', true, ...
                          'plotStates', true, ...
                          'plotCountries', true, ...
        ...
        saveData = struct('data', {resultHigh}, ...
                          ...
                          'fileTitle', ['toe-model-range-upper-' num2str(tcrit) '-' fileExt '.pdf'], ...
                          'plotXUnits', 'Year', ...
                          'blockWater', true, ...
                          'plotStates', true, ...
                          'plotCountries', true, ...
...
saveData = struct('data', {{lat, lon, nanmean(rankings, 3)}}, ...
                  'plotRegion', 'usne', ...
                  'plotRange', [2005 2090], ...
                  'plotTitle', 'Time of emergence, multi-run mean', ...
                  'fileTitle', ['toe-multi-run-mean-' num2str(tcrit) '-' fileExt '.pdf'], ...
                  'plotXUnits', 'Year', ...
                  'blockWater', true, ...
                  'plotStates', true, ...
                  'plotCountries', true, ...
