...
% baseModels = {''};
% testModels = {''};
baseModels = {'crcm/ccsm', 'crcm/cgcm3', 'hrm3/gfdl', 'hrm3/hadcm3', 'mm5i/ccsm', 'wrfg/ccsm'};
testModels = {'crcm/ccsm', 'crcm/cgcm3', 'hrm3/gfdl', 'hrm3/hadcm3', 'mm5i/ccsm', 'wrfg/ccsm'};
                ...
                for xlat = 1:size(testProfileData{y}, 1)
                    for ylon = 1:size(testProfileData{y}, 2)
                        ...
                        while length(maxIndex) == 0
                            ...
                            maxIndex = find(squeeze(curYearProfile(:, startingPlev)) == nanmax(squeeze(curYearProfile(:, startingPlev))));
                        end
                        ...
                        if length(maxIndex) > 0
                            ...
                            level = [level squeeze(nanmean(curYearProfile(maxIndex, startingPlev:5), 1))];
...
plotTitle = ['NARCCAP NE summer mean temperature profile change'];
