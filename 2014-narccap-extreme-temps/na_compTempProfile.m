compType = 'narccap-sw-past-future';

if strcmp(compType, 'narccap-ne-past-future')
    ...
    close all;
elseif strcmp(compType, 'narccap-sw-past-future')
    ...
    close all;
elseif strcmp(compType, 'ne-base')
    ...
    close all;
elseif strcmp(compType, 'sw-base')
