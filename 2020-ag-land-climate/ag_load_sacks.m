...
for c = 1:length(crops)
    ...
    save(['E:/data/ecoffel/data/projects/ag-land-climate/sacks/sacks-' crops{c} '.mat'], 'calendar');
    
    plantingEnd(isnan(plantingEnd)) = -1;
    harvestStart(isnan(harvestStart)) = -1;
    dlmwrite(['E:/data/ecoffel/data/projects/ag-land-climate/sacks/sacks-planting-end-' crops{c} '.txt'], plantingEnd);
    dlmwrite(['E:/data/ecoffel/data/projects/ag-land-climate/sacks/sacks-harvest-start-' crops{c} '.txt'], harvestStart);
